    ...
    >
      ...
      <div className="content">
        ...
        <div className="pg-header">
          <div>
            <div className="pg-title">Sales Dashboard 111</div>
            <div className="pg-sub">
              Monitor inquiries, BOM progress, quotes, deposits, and sales
        ...
        <div className="kpi-grid mb20">
          <div className="kpi-card dark">
            ...
            <div className="kpi-bar">
              <div className="kpi-bar-fill" style={{ width: "78%" }} />
            </div>
          </div>
          ...
          <div className="kpi-card">
            ...
            <div className="kpi-bar">
              <div
                ...
                style={{ width: "40%", background: "var(--red)" }}
              />
            </div>
          </div>
          <div className="kpi-card">
          ...
          <div className="kpi-card">
            ...
            <div className="kpi-bar">
              <div
                className="kpi-bar-fill"
                style={{ width: "70%", background: "var(--green)" }}
              />
            </div>
          </div>
          <div className="kpi-card">
            ...
            <div className="kpi-note" style={{ color: "var(--amber)" }}>
              1 overdue — follow up
            </div>
            <div className="kpi-bar">
              <div
        ...
        <div className="card mb16">
          ...
          <div className="pipeline-grid">
            <div className="pipe-stage">
              ...
              <div className="ps-count" style={{ color: "var(--red)" }}>
                18
              </div>
            ...
            <div className="pipe-stage">
              ...
              <div className="ps-count" style={{ color: "#8a5c00" }}>
                7
              </div>
            ...
            <div className="pipe-stage">
              ...
              <div className="ps-count" style={{ color: "var(--green)" }}>
                9
              </div>
          ...
          <div className="card-pad" style={{ paddingBottom: 0 }}>
            <div className="card-header">
              <div>
                ...
                <div className="card-sub">
                  Latest client requests requiring sales action
                </div>
              </div>
          ...
          <div className="table-wrap">
            <table>
              ...
              <tbody>
                <tr>
                  <td>
                    <div className="td-id">INQ-2026-031</div>
                  </td>
                  <td>
                    <div className="td-main">Rajesh Jewellers</div>
                    <div className="td-meta">Mumbai · Regular client</div>
                  </td>
                  <td>
                    <div className="td-main">Diamond Bracelet Set</div>
                    <div className="td-meta">
                      Category: Diamond · 18K White Gold
                    </div>
                  </td>
                  <td>25 pcs</td>
                  <td className="td-amount">₹66,000/pc</td>
                  <td>
                    <div className="td-meta">Anika Mehta</div>
                  </td>
                  <td>
                    <span className="pill p-new">
                      <span className="pdot" />
                      New
                    </span>
                  </td>
                  <td>
                    ...
                    >
                      ...
                      <button className="btn-sm red">Start BOM</button>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td>
                    <div className="td-id">INQ-2026-030</div>
                  </td>
                  <td>
                    <div className="td-main">Meena Crafts</div>
                    <div className="td-meta">Delhi · Since 2021</div>
                  </td>
                  <td>
                    <div className="td-main">Gold Necklace Set</div>
                    <div className="td-meta">Category: Gold · 22K</div>
                  </td>
                  <td>50 pcs</td>
                ...
                <tr>
                  <td>
                    <div className="td-id">INQ-2026-029</div>
                  </td>
                  <td>
                    <div className="td-main">Priya Gold House</div>
                    <div className="td-meta">Jaipur · New client</div>
                  </td>
                  <td>
                    <div className="td-main">Kundan Ring Set</div>
                    <div className="td-meta">Category: Kundan · Meenakari</div>
                  </td>
                  <td>10 pcs</td>
                  <td className="td-amount">₹38,000/pc</td>
                  <td>
                    <div className="td-meta">Ravi Kumar</div>
                  </td>
                  <td>
                    <span className="pill p-match">
                      <span className="pdot" />
                      Style Match Found
                    </span>
                  </td>
                  <td>
                    ...
                    >
                      <button className="btn-sm">View</button>
                      <button className="btn-sm red">Create Quote</button>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td>
                    <div className="td-id">INQ-2026-028</div>
                  </td>
                  <td>
                    <div className="td-main">Sunita Agarwal</div>
                    <div className="td-meta">Surat · Via WhatsApp</div>
                  </td>
                  <td>
                    <div className="td-main">Polki Maang Tikka</div>
                    <div className="td-meta">Category: Polki · Bridal Set</div>
                  </td>
                  <td>5 pcs</td>
                ...
                <tr>
                  <td>
                    <div className="td-id">INQ-2026-027</div>
                  </td>
                  <td>
                    <div className="td-main">Anita Jewels</div>
                    <div className="td-meta">Ahmedabad · Regular</div>
                  </td>
                  <td>
                    <div className="td-main">Silver Anklet Set</div>
                    <div className="td-meta">Category: Silver · 925</div>
                  </td>
                  <td>30 pcs</td>
                ...
                <tr>
                  <td>
                    <div className="td-id">INQ-2026-026</div>
                  </td>
                  <td>
                    <div className="td-main">Kavita Joshi</div>
                    <div className="td-meta">Kolkata · Via email</div>
                  </td>
                  <td>
                    <div className="td-main">Bridal Earrings Set</div>
                    <div className="td-meta">
                      Category: Kundan · Heavy bridal
                    </div>
                  </td>
                  <td>8 pcs</td>
        ...
        <div className="two-col">
          ...
          <div className="card card-pad">
            <div className="card-header">
              <div>
                <div className="card-title">BOM Workqueue</div>
                <div className="card-sub">
                  Pending BOM tasks requiring your attention
                </div>
              </div>
            ...
            <div className="wq-item">
              <div>
                ...
                <div className="wq-due urgent">
                  Due: Today — Awaiting component confirmation
                </div>
              </div>
            ...
            <div className="wq-item">
              <div>
                ...
                <div className="wq-due">
                  Due: 12 Apr — Pending style mapping
                </div>
              </div>
          ...
          <div className="card card-pad">
            <div className="card-header">
              <div>
                <div className="card-title">Quote Follow-ups</div>
                <div className="card-sub">
                  Quotes requiring action or follow-up
                </div>
              </div>
              <span className="card-action">View All →</span>
            </div>
            <div className="wq-item">
              <div>
                ...
                <div className="wq-due urgent">
                  Follow-up: Today — Awaiting response (3 days)
                </div>
              </div>
            ...
            <div className="wq-item">
              <div>
                ...
                <div className="wq-due urgent">
                  Negotiation — Client requested target ₹35,000
                </div>
              </div>
            ...
            <div className="wq-item">
              <div>
                ...
                <div className="wq-due">
                  Follow-up: 10 Apr — Send updated version
                </div>
              </div>
            ...
            <div className="wq-item">
              <div>
                ...
                <div className="wq-due">
                  Follow-up: 12 Apr — Awaiting response
                </div>
              </div>
            ...
            <div className="wq-item">
              <div>
                ...
                <div className="wq-due urgent">
                  Expiring: 13 Apr — Revised pricing requested
                </div>
              </div>
              <button className="btn-sm red">Revise</button>
            </div>
        ...
        <div className="card card-pad mb16">
          <div className="card-header">
            <div>
              <div className="card-title">Pending Commercial Actions</div>
              <div className="card-sub">
                High-priority tasks requiring immediate sales attention
              </div>
            </div>
            <span className="card-action">View All →</span>
          </div>
          <div className="ca-item">
            ...
            <div className="ca-body">
              ...
              <div className="ca-desc">
                Proforma unsigned for 5 days — signature required to release
                production
              </div>
            </div>
          ...
          <div className="ca-item">
            ...
            <div className="ca-body">
              ...
              <div className="ca-desc">
                Deposit of ₹1,09,200 overdue by 2 days — blocking production
                start
              </div>
            </div>
          ...
          <div className="ca-item">
            ...
            <div className="ca-body">
              <div className="ca-client">Rajesh Jewellers</div>
              <div className="ca-desc">
                Quote expiring in 2 days — no response received. Diamond
                Bracelet Set × 25
              </div>
            </div>
          ...
          <div className="ca-item">
            ...
            <div className="ca-body">
              ...
              <div className="ca-desc">
                Client requested revised pricing at ₹35,000/pc. Revised quote v3
                pending from costing
              </div>
            </div>
          ...
          <div className="ca-item">
            ...
            <div className="ca-body">
              ...
              <div className="ca-desc">
                Production handoff awaiting sales confirmation — Tier 1 remarks
                not yet added
              </div>
            </div>
          ...
          <div className="ca-item">
            ...
            <div className="ca-body">
              ...
              <div className="ca-desc">
                Sales order blocked — deposit of ₹40,500 not yet received.
                Proforma signed.
              </div>
            </div>
        ...
        <div className="two-col">
          <div className="card card-pad">
            <div className="card-header">
              <div>
                <div className="card-title">Top Clients This Month</div>
              </div>
            ...
            >
              <div className="client-card">
                <div className="cc-av" style={{ background: "var(--red)" }}>
                  R
                </div>
              ...
              <div className="client-card">
                <div className="cc-av" style={{ background: "#1a1a3e" }}>
                  M
                </div>
              ...
              <div className="client-card">
                <div className="cc-av" style={{ background: "#2d4a1e" }}>
                  P
                </div>
              ...
              <div className="client-card">
                <div className="cc-av" style={{ background: "#4a1e2d" }}>
                  A
                </div>
          ...
          <div className="card card-pad">
            <div className="card-header">
              <div>
                ...
                <div className="card-sub">Frequently used sales shortcuts</div>
              </div>
            </div>
          ...
          <div className="card card-pad">
            <div className="card-header">
              <div>
                ...
                <div className="card-sub">Audit trail of sales actions</div>
              </div>
            ...
            <div className="timeline">
              <div className="tl-item">
                ...
                <div className="tl-text">
                  <strong>QT-2026-041</strong> accepted by Rajesh Jewellers —
                  Diamond Bracelet Set × 25
                </div>
              ...
              <div className="tl-item">
                ...
                <div className="tl-text">
                  <strong>BOM-2026-113</strong> created for STY-004 v2 — Kundan
                  Ring Set
                </div>
              ...
              <div className="tl-item">
                ...
                <div className="tl-text">
                  Deposit ₹1,09,200 received for <strong>SO-2026-022</strong> —
                  Meena Crafts
                </div>
              ...
              <div className="tl-item">
                ...
                <div className="tl-text">
                  Proforma <strong>PF-2026-011</strong> sent for digital signing
                  — Rajesh Jewellers
                </div>
              ...
              <div className="tl-item">
                ...
                <div className="tl-text">
                  Revised quote <strong>QT-2026-040 v2</strong> created after
                  target price discussion — Priya Gold House
                </div>
                <div className="tl-time">Yesterday</div>
              </div>
              <div className="tl-item">
                <div className="tl-dot-col">
                  <div className="tl-dot black" />
                </div>
                <div className="tl-text">
                  Sales order <strong>SO-2026-021</strong> confirmed and pushed
                  to production handoff queue
                </div>
                <div className="tl-time">Yesterday</div>
              </div>
              <div className="tl-item">
                ...
                <div className="tl-text">
                  Prior QC note surfaced for repeat bracelet order — diamond
                  setting issue flagged for production team
                </div>
              ...
              <div className="tl-item">
                ...
                <div className="tl-text">
                  Estimate <strong>EST-2026-018</strong> approved by Costing for
                  Gold Necklace Set — ready for quote
                </div>
                <div className="tl-time">Apr 6</div>
              </div>
              <div className="tl-item">
                ...
                <div className="tl-text">
                  Client Kavita Joshi uploaded revised design attachment for
                  bridal earrings — INQ-2026-026
                </div>
              ...
              <div className="tl-item">
                ...
                <div className="tl-text">
                  Production team acknowledged <strong>PIN-2026-008</strong> —
                  Gold Necklace Set production started
                </div>
                <div className="tl-time">Apr 5</div>
              </div>
            </div>
          ...
          <div className="card card-pad">
            ...
            <div className="alert-item">
              ...
              <div className="ai-body">
                ...
                <div className="ai-note">
                  QT-2026-041, QT-2026-039, QT-2026-037 — extend or follow up
                  now
                </div>
              </div>
            ...
            <div className="alert-item">
              ...
              <div className="ai-body">
                ...
                <div className="ai-note">
                  Meena Crafts deposit of ₹1,09,200 is 2 days late. Production
                  on hold.
                </div>
              </div>
            ...
            <div className="alert-item">
              ...
              <div className="ai-body">
                ...
                <div className="ai-note">
                  BOM-2026-112 (Gold Necklace Set) — revision overdue by 1 day
                </div>
              </div>
            ...
            <div className="alert-item">
              ...
              <div className="ai-body">
                <div className="ai-msg">
                  4 inquiries have no next action assigned
                </div>
                <div className="ai-note">
                  INQ-2026-031, 028, 026, 025 — unassigned next steps
                </div>
              </div>
            ...
            <div className="alert-item">
              ...
              <div className="ai-body">
                <div className="ai-msg">
                  Proforma unsigned for 5 days — PF-2026-011
                </div>
                <div className="ai-note">
                  Rajesh Jewellers has not signed. Production cannot begin
                  without signature.
                </div>
              </div>
            ...
            <div className="alert-item">
              ...
              <div className="ai-body">
                <div className="ai-msg">
                  2 repeat clients waiting on revised quotes
                </div>
                <div className="ai-note">
                  Priya Gold House (v3) and Sunita Agarwal (v2) — revised quote
                  pending
                </div>
              </div>
            ...
            <div className="alert-item">
              ...
              <div className="ai-body">
                <div className="ai-msg">
                  2 deposits pending confirmation from Accounts
                </div>
                <div className="ai-note">
                  PF-2026-010 (Sunita Agarwal) and PF-2026-009 (Anita Jewels)
                  awaiting
                </div>
              </div>
