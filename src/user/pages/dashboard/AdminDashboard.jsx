...
const Dashboard = () => {
  ...
  quotes.byStatus.forEach((q) => {
    quoteStatusMap[q.status] = parseInt(q.count);
  });
      ...
      <div className="pg-header">
        <div>
          ...
          <div className="pg-sub">
            System-wide overview — users, styles, inquiries, estimates and
            quotes.
          </div>
        </div>
      ...
      <div className="kpi-grid mb20">
        <div className="kpi-card dark">
          ...
          <div className="kpi-note up">
            Accepted: {fmt(quotes.acceptedValue)}
          </div>
        ...
        <div className="kpi-card">
          ...
          <div
            ...
            style={{
              color:
                estimates.pendingCount > 0 ? "var(--amber)" : "var(--green)",
            }}
          >
          ...
          <div className="kpi-bar">
            <div
              className="kpi-bar-fill"
              style={{
                width: `${Math.min(estimates.pendingCount * 10, 100)}%`,
        ...
        <div className="kpi-card">
          ...
          <div className="kpi-note">
            {users.byRole.length} roles · {styles.total} styles
          </div>
          <div className="kpi-bar">
            <div
              className="kpi-bar-fill"
          ...
          <div className="card-header" style={{ marginBottom: 14 }}>
            <div>
              ...
              <div className="card-sub">
                Current distribution across all sales stages
              </div>
            </div>
            <span
        ...
        <div className="card card-pad">
            ...
            <div className="alert-item">
              ...
              <div className="ai-body">
                ...
                <div className="ai-note">
                  By {alerts.lastRateUpdate.updated_by_name} ·{" "}
                  {formatDate(alerts.lastRateUpdate.created_at, true)}
                </div>
              </div>
            ...
            <div className="alert-item">
              ...
              <div className="ai-body">
                <div className="ai-msg">
                  {alerts.assetsWithoutRateToday.length} Assets Missing Today's
                  Rate
                </div>
                <div className="ai-note">
                  Update rates before creating new estimates.
                </div>
              </div>
              ...
              {alerts.expiringQuotes.map((q) => (
                <div key={q.id} className="alert-item">
                  ...
                  <div className="ai-body">
                    ...
                    <div className="ai-note">
                      {q.style_name} · {fmt(q.total_value)} · Expires{" "}
          ...
          {alerts.overdueEstimates?.length > 0 && (
            <div className="alert-item">
              ...
              <div className="ai-body">
                <div className="ai-msg">
                  {alerts.overdueEstimates.length} Overdue Estimates
                </div>
          ...
          <div className="card-header">
            <div>
              ...
              <div className="card-sub">
                ...
                {users.byStatus.find((s) => s.status === "active")?.count || 0}{" "}
                active
              </div>
            </div>
            <span className="card-action" onClick={() => navigate("/users")}>
              Manage →
            </span>
          </div>
            ...
            <tbody>
              {users.byRole.map((r) => (
                <tr key={r.role}>
                  <td>
                    <span
                      className={`role-badge ${ROLE_BADGE[r.role] || "rb-vendor"}`}
                    >
        ...
        <div className="card card-pad">
          <div className="card-header">
            <div>
              ...
              <div className="card-sub">
                Latest client inquiries in the system
              </div>
            </div>
            <span
              className="card-action"
          ...
          <tbody>
            {recentActivity.users.map((u, idx) => (
              <tr key={u.id}>
                ...
                <td>
                  <span
                    className={`role-badge ${ROLE_BADGE[u.role] || "rb-vendor"}`}
                  >
                ...
                <td>
                  <span
                    className={`pill ${u.status === "active" ? "p-active" : "p-inactive"}`}
                  >
                    <span className="pdot" />
                    {u.status}
                  </span>
