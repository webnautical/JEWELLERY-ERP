...
const RDDashboard = () => {
  ...
  const archivedCount = parseInt(
    overview.byStatus.find((s) => s.status === "archived")?.count || 0,
  );
    ...
    <div className="page-wrapper">
      ...
      <div className="pg-header">
        <div>
          ...
          <div className="pg-sub">
            Overview of styles, designs and material configurations.
          </div>
        </div>
      ...
      <div className="kpi-grid mb20">
        ...
        <div className="kpi-card">
          ...
          <div className="kpi-bar">
            <div
              className="kpi-bar-fill"
              style={{
                width: `${Math.round((overview.myStyles / (overview.totalStyles || 1)) * 100)}%`,
        ...
        <div className="kpi-card">
          ...
          <div className="kpi-bar">
            <div className="kpi-bar-fill" style={{ width: "50%" }} />
          </div>
        </div>
        <div className="kpi-card">
          ...
          <div className="kpi-bar">
            <div
              className="kpi-bar-fill"
              style={{
                width: `${Math.round((activeCount / (overview.totalStyles || 1)) * 100)}%`,
                background: "var(--green)",
              }}
            />
          </div>
      ...
      <div className="two-col mb16">
        ...
        <div className="card card-pad">
          <div className="card-header">
            ...
            <span className="card-action" onClick={() => navigate("/styles")}>
              View All →
            </span>
          </div>
              ...
              {mostUsedStyles.length === 0 ? (
                ...
                mostUsedStyles.map((s, idx) => (
                  <tr key={s.id}>
                    ...
                    <td>
                      <span className="role-badge rb-sales">
                        {s.inquiry_count} inquiries
                      </span>
                    </td>
                    <td>
                      <button
                        className="btn-sm"
                        onClick={() => navigate(`/styles/edit/${s.id}`)}
                      >
                        View
                      </button>
                    </td>
        ...
        <div className="card card-pad">
          ...
          {alerts.stylesWithoutBOM?.length > 0 ? (
            <div className="alert-item">
              ...
              <div className="ai-body">
                <div className="ai-msg">
                  {alerts.stylesWithoutBOM.length} Styles Without BOM
                </div>
                <div className="ai-note">
                  These styles have no Bill of Materials attached.
                </div>
              </div>
            ...
            <div className="alert-item">
              ...
              <div className="ai-body">
                ...
                <div className="ai-note">
                  Every active style has a Bill of Materials.
                </div>
              </div>
          ...
          {alerts.draftStyles?.length > 0 ? (
            <div className="alert-item">
              ...
              <div className="ai-body">
                <div className="ai-msg">
                  {alerts.draftStyles.length} Draft Styles
                </div>
                <div className="ai-note">
                  These styles are still in draft — publish when ready.
                </div>
              </div>
            ...
            <div className="alert-item">
              ...
              <div className="ai-body">
                ...
                <div className="ai-note">
                  All styles are published and active.
                </div>
              </div>
              <div className="ai-tag tag-ok">All Clear</div>
            </div>
